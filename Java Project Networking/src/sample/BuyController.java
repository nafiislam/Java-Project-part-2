...
public class BuyController {
    ...
    private void initializeColumns() {
        ...
        tableView.getColumns().addAll(nameCol, countryCol, ageCol, heightCol,clubCol,positionCol,numberCol,salaryCol,priceCol);
    }
    ...
    public void load() {
        ...
        for(Player s:main.getMarketPlayerList()){
            data.add(s);
        }
    ...
    @FXML
    void buy(ActionEvent actionEvent) {
